...
use App\Http\Controllers\Admin\Project\DownloadReportProjectPdfController;
use App\Http\Controllers\Admin\Project\ReportProjectController;
use App\Http\Controllers\Admin\Project\ShowReportTaskController;
...
Route::middleware(['auth', 'checkRole:executive', 'nocache'])->group(function () {
    Route::prefix('/executive')->group(function () {
        ...
        Route::prefix('/project')->group(function () {
            ...
            Route::get('/{id}/report', ReportProjectController::class)->name('executive.project.report');
            Route::get('/{id}/report/pdf', DownloadReportProjectPdfController::class)->name('executive.project.report.pdf');
            Route::get('/{id}/report/task/{taskId}', ShowReportTaskController::class)->name('executive.project.report.task');
...
Route::middleware(['auth', 'checkRole:director', 'nocache'])->group(function () {
    Route::prefix('/director')->group(function () {
        ...
        Route::prefix('/project')->group(function () {
            ...
            Route::get('/{id}/report', ReportProjectController::class)->name('director.project.report');
            Route::get('/{id}/report/pdf', DownloadReportProjectPdfController::class)->name('director.project.report.pdf');
            Route::get('/{id}/report/task/{taskId}', ShowReportTaskController::class)->name('director.project.report.task');
