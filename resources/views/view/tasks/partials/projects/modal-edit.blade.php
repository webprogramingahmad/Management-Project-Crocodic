    ...
    <div class="modal-content">
        ...
        <form id="form-edit-task" method="POST"
            ...
            @elseif($role === 'executive')
                action="{{ route('executive.project.task.update', $project->id) }}"
            @else
                action="{{ route('director.project.task.update', $project->id) }}"
            @endif>
            @csrf
            <div class="modal-body">
                <input type="hidden" name="id" id="edit_task_id">

                <div id="edit-task-normal-fields">
                    <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="edit-task-submit-btn" class="btn btn-primary">Update Task</button>
            </div>
        </form>
    </div>
</div>
