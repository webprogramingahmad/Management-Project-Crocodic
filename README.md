<h1>Cara Menjalankan Project Ini</h1>
<h2>📋 Prasyarat</h2>
<ul>
    <li>PHP (minimal 8.2)</li>
    <li>Composer</li>
    <li>Node.js & NPM</li>
    <li>Git</li>
...
<pre><code>git clone https://github.com/Hamkar1417/project-crocodic.git cd nama-repo</code></pre>
<h3>2. Install Dependencies</h3>
<pre><code>composer install npm install</code></pre>
<h3>3. Konfigurasi Environment</h3>
<pre><code>cp .env.example .env</code></pre>
<p class="muted">Lalu edit <code>.env</code> sesuai environment lokal, khususnya bagian database:</p>
<pre><code>APP_NAME="NamaProject"
APP_ENV=local
APP_KEY=
APP_DEBUG=true
...
DB_HOST=127.0.0.1
DB_PORT=3306
DB_DATABASE=crocodic
DB_USERNAME=root
DB_PASSWORD=</code></pre>
<h3>4. Generate Key</h3>
<pre><code>php artisan key:generate</code></pre>
<h3>5. Buat Database</h3>
<p class="muted">Buat database baru di MySQL sesuai nama di <code>.env</code>:</p>
<pre><code>CREATE DATABASE crocodic;</code></pre>
<h3>6. Jalankan Migrasi & Seeder</h3>
<pre><code>php artisan migrate --seed</code></pre>
<h3>7. Jalankan Server</h3>
